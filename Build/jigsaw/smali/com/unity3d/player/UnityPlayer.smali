...
.field b:Lcom/unity3d/player/q;

.field private c:Z

.field private d:Z

.field private final e:Lcom/unity3d/player/i;

.field private final f:Lcom/unity3d/player/r;

.field private g:Z

.field private h:Lcom/unity3d/player/t;
...
.field private final w:Lcom/unity3d/player/p;

.field private x:Ljava/lang/String;

.field private y:Landroid/net/NetworkInfo;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/unity3d/player/UnityPlayer;->F:Ljava/util/concurrent/locks/Lock;
...
.method public constructor <init>(Landroid/content/ContextWrapper;)V
    ...
    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->h:Lcom/unity3d/player/t;

    new-instance v0, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->i:Ljava/util/concurrent/ConcurrentLinkedQueue;

    iput-object v1, p0, Lcom/unity3d/player/UnityPlayer;->j:Landroid/content/BroadcastReceiver;
    ...
    iput v3, p0, Lcom/unity3d/player/UnityPlayer;->u:I

    iput v3, p0, Lcom/unity3d/player/UnityPlayer;->v:I

    iput-object v1, p0, Lcom/unity3d/player/UnityPlayer;->x:Ljava/lang/String;

    iput-object v1, p0, Lcom/unity3d/player/UnityPlayer;->y:Landroid/net/NetworkInfo;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->z:Landroid/os/Bundle;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->A:Ljava/util/List;

    iput-object v1, p0, Lcom/unity3d/player/UnityPlayer;->b:Lcom/unity3d/player/q;

    iput-object v1, p0, Lcom/unity3d/player/UnityPlayer;->C:Landroid/widget/ProgressBar;
    ...
    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->D:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->E:Ljava/lang/Runnable;
    ...
    invoke-direct {v0, p0}, Lcom/unity3d/player/r;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->f:Lcom/unity3d/player/r;
    ...
    invoke-direct {v0, p1}, Lcom/unity3d/player/n;-><init>(Landroid/content/ContextWrapper;)V

    :goto_0
    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->e:Lcom/unity3d/player/i;
    ...
    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->w:Lcom/unity3d/player/p;
    ...
    sget-object v0, Lcom/unity3d/player/o;->h:Lcom/unity3d/player/f;
    ...
    invoke-interface {v0}, Lcom/unity3d/player/f;->a()V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->f:Lcom/unity3d/player/r;

    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->m:Landroid/view/SurfaceView;

    invoke-virtual {v0, v1}, Lcom/unity3d/player/r;->c(Landroid/view/View;)V

    iput-boolean v3, p0, Lcom/unity3d/player/UnityPlayer;->s:Z
    ...
    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->n:Landroid/os/PowerManager$WakeLock;
    ...
    sget-object v0, Lcom/unity3d/player/o;->k:Lcom/unity3d/player/g;
    ...
    sget-object v0, Lcom/unity3d/player/o;->j:Lcom/unity3d/player/h;
...
.method static synthetic a(Lcom/unity3d/player/UnityPlayer;Landroid/widget/ProgressBar;)Landroid/widget/ProgressBar;
    ...
    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->C:Landroid/widget/ProgressBar;

    return-object p1
.end method

.method static synthetic a(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/u;)Lcom/unity3d/player/u;
    .locals 0

    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->B:Lcom/unity3d/player/u;
...
.method private a()V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->z:Landroid/os/Bundle;
...
.method private static a(Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-static {}, Lcom/unity3d/player/t;->a()V
...
.method private static a(Ljava/lang/String;Landroid/os/PowerManager$WakeLock;Z)V
    ...
    invoke-static {v6, v0}, Lcom/unity3d/player/l;->Log(ILjava/lang/String;)V
...
.method private a(Z)V
    ...
    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->n:Landroid/os/PowerManager$WakeLock;
...
.method private c(Ljava/lang/Runnable;)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->i:Ljava/util/concurrent/ConcurrentLinkedQueue;
...
.method private d()V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->A:Ljava/util/List;
...
.method static synthetic e(Lcom/unity3d/player/UnityPlayer;)Landroid/view/SurfaceView;
    .locals 1
...
.method static synthetic f(Lcom/unity3d/player/UnityPlayer;)Lcom/unity3d/player/r;
    .locals 1
...
.method private g()V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->h:Lcom/unity3d/player/t;

    invoke-virtual {v0}, Lcom/unity3d/player/t;->e()Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->B:Lcom/unity3d/player/u;
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/u;->onResume()V
    ...
    invoke-virtual {v0, v1}, Lcom/unity3d/player/t;->c(Z)V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->w:Lcom/unity3d/player/p;

    invoke-virtual {v0}, Lcom/unity3d/player/p;->e()V

    iput-object v2, p0, Lcom/unity3d/player/UnityPlayer;->x:Ljava/lang/String;

    iput-object v2, p0, Lcom/unity3d/player/UnityPlayer;->y:Landroid/net/NetworkInfo;
...
.method private static i()V
    ...
    :cond_1
    invoke-static {}, Lcom/unity3d/player/t;->b()V
...
.method private k()V
    ...
    iget-object v5, p0, Lcom/unity3d/player/UnityPlayer;->z:Landroid/os/Bundle;
    ...
    :cond_2
    iget-object v3, p0, Lcom/unity3d/player/UnityPlayer;->z:Landroid/os/Bundle;
...
.method static synthetic l(Lcom/unity3d/player/UnityPlayer;)Landroid/widget/ProgressBar;
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->C:Landroid/widget/ProgressBar;
...
.method protected static lockNativeAccess()V
    ...
    sget-object v0, Lcom/unity3d/player/UnityPlayer;->F:Ljava/util/concurrent/locks/Lock;
...
.method static synthetic p(Lcom/unity3d/player/UnityPlayer;)Lcom/unity3d/player/u;
    .locals 1
...
.method protected closeCamera(I)V
    ...
    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->A:Ljava/util/List;
...
.method protected forwardMotionEventToDalvik(JJII[I[FIFFIIIII[J[F)V
    ...
    iget-object v3, v0, Lcom/unity3d/player/UnityPlayer;->e:Lcom/unity3d/player/i;
...
.method protected hideSoftInput()V
    ...
    sget-boolean v1, Lcom/unity3d/player/o;->g:Z
...
.method public pause()V
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/u;->onPause()V
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/t;->f()Z
    ...
    invoke-virtual {v0, v4}, Lcom/unity3d/player/t;->c(Z)V

    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->h:Lcom/unity3d/player/t;

    invoke-virtual {v0, v5}, Lcom/unity3d/player/t;->b(Z)V
    ...
    invoke-static {v6, v1}, Lcom/unity3d/player/l;->Log(ILjava/lang/String;)V
...
.method public quit()V
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/t;->d()Z
    ...
    :goto_0
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->j:Landroid/content/BroadcastReceiver;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->l:Landroid/content/ContextWrapper;

    iget-object v1, p0, Lcom/unity3d/player/UnityPlayer;->j:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/unity3d/player/UnityPlayer;->j:Landroid/content/BroadcastReceiver;
...
.method public resume()V
    ...
    invoke-virtual {v0, v1}, Lcom/unity3d/player/t;->b(Z)V
...
.method protected setFullscreen(Z)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/unity3d/player/UnityPlayer$3;-><init>(Lcom/unity3d/player/UnityPlayer;Z)V
...
.method protected startActivityIndicator()V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->D:Ljava/lang/Runnable;
...
.method protected stopActivityIndicator()V
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->E:Ljava/lang/Runnable;
...
.method public windowFocusChanged(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/unity3d/player/t;->a(Z)V

    if-eqz p1, :cond_0

    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->b:Lcom/unity3d/player/q;
